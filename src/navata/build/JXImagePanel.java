...
public class JXImagePanel extends JPanel {
	...
	// TODO remove this constructor; no where else can a URL be used in this
	// class
	 ...
	 *            to be painted. If the preferred size has not been explicitly
	 *            set, then the image dimensions will alter the preferred size
	 *            of the panel.
	 */
	...
	/**
	 * {@inheritDoc} The old property value in PCE fired by this method might
